                ...
                <div class="card-body">
                    ...
                    {{ csrf_field() }}
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="product[name_product]" placeholder="Áo Thun Nam" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-line">
                                    <input type="file" class="form-control" name="product[img_product]" required>
                                </div>
                            </div>
                            <label for="inputEmail3" class="col-sm-2  col-form-label text-right">Số Lượng</label>
                            <div class="col-sm-4">
                                <div class="form-line">
                                    <input type="number" min="1" class="form-control" name="product[quantity]" placeholder="999999" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-line">
                                    <input type="number" min="0" class="form-control" name="product[price]" placeholder="999999" required>
                                </div>
                            </div>
                            <label for="inputEmail3" class="col-sm-2  col-form-label text-right">Giảm Giá</label>
                            <div class="col-sm-4">
                                <div class="form-line">
                                    <input type="number" min="1" class="form-control" name="product[sale]" placeholder="%" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="product[company]" placeholder="Công Ty TNHH "required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-line">
                                    <textarea style="height: 200px;" type="text" class="form-control" name="product[descrip]"required></textarea>
                                </div>
                            </div>
                        </div>
                        
                        <button type="submit" value="1" name="btnAddProduct" class="btn btn-primary btn-block waves-effect">
